...
function FeedbackDetailPage() {
  const { getFeedbackDetail, feedbackDetail, updateFeedback, isLoading, error } = useFeedback();
  ...
  useEffect(() => {
    if (feedbackDetail) {
      setName(feedbackDetail?.name)
      setDesc(feedbackDetail?.desc)
      setStars(feedbackDetail?.stars)
      setImageData(feedbackDetail?.images)
    }
  }, [feedbackDetail])
